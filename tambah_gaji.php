        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-body">
                        <h1 class="card-title text-center mb-4">Tambah Gaji Pegawai</h1>
                        ...
                        <form method="post" action="add_gaji.php">
                            ...
                            <div class="mb-3">
                                <label for="gaji_pokok" class="form-label">Nama</label>
                                <input type="text" disabled class="form-control" id="gaji_pokok" name="gaji_pokok"
                                    placeholder="Gaji Pokok" value="<?= $dt['nama'] ?>">
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary w-100" name="submit">Tambah Gaji
                                Pegawai</button>
                        </form>
                    </div>
                </div>
